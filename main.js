    ...
    let Quiz = await inquirer.prompt([
        {
            ...
            type: 'list',
            choices: ['Veriables', 'Modules', 'Loops', 'Js_Ts', 'Asynchronous', 'Synchronous', 'Arrays', "All_Data", "Exit"]
        }
    ]);
    switch (Quiz.data) {
        case 'Veriables':
...
async function All_Data() {
    ...
    table.push([total_Questions, correct_Answers, `${percentage.toFixed(2)}%`, Grade]);
    // Display the table
    console.log(table.toString());
}
